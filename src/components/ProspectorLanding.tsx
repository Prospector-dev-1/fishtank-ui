...
import { Bell, PlayCircle, Phone, CheckCircle, Lightbulb, TrendingUp, Target, ChevronDown, ChevronUp, Star, ChevronRight, ArrowUp, Download, Upload, BarChart3, Instagram, Brain, RotateCcw, Trophy } from 'lucide-react';
...
export default function ProspectorLanding() {
  ...
  return <div className="min-h-screen bg-background text-foreground">
      {/* Navigation */}
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isNavVisible ? 'h-14 bg-background-charcoal/95 backdrop-blur-nav border-b border-divider' : 'h-16 bg-background-charcoal/85 backdrop-blur-nav'}`}>
        <div className="container mx-auto h-full flex items-center justify-between">
          {/* Logo */}
          <div className="flex items-center gap-2">
            <img src={prospectorLogo} alt="Prospector logo" className="min-h-min " />
            <span className="text-body-s font-semibold tracking-wide hidden md:block">PROSPECTOR</span>
          </div>

          {/* Desktop Navigation */}
          <div className="hidden md:flex items-center gap-8">
            <button onClick={scrollToHowItWorks} className="text-body-s text-text-medium hover:text-text-high transition-colors hover:underline underline-offset-4">
              How it Works
            </button>
      ...
      <section className="pt-24 md:pt-30 pb-16 md:pb-22">
        <div className="container mx-auto">
          <MotionDiv variants={containerVariants} initial="hidden" animate="show" className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            {/* Text Content */}
            <div className="text-center lg:text-left">
              ...
              <motion.div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                <Button variant="primary" size="lg" onClick={scrollToBeta} className="w-full sm:w-auto">
                  <Bell className="w-4 h-4 mr-2" />
                  Join the Beta
                </Button>
                <Button variant="ghost" size="lg" onClick={() => window.open('https://instagram.com/prospector.app', '_blank')} className="w-full sm:w-auto">
            ...
            ease: "easeInOut"
              ...
              <div className="relative">
                ...
                <img src={screenshot1} alt="Prospector dashboard showing Quick Actions" className="relative w-[300px] lg:w-[400px] h-auto rounded-2xl shadow-card transform rotate-[8deg] hover:rotate-[6deg] transition-transform duration-300" />
              </div>
            </motion.div>
          </MotionDiv>
        </div>
        ...
        <div className="container mx-auto">
          ...
          duration: 0.6
            ...
            <div className="flex justify-center items-center gap-8 overflow-x-auto pb-2">
              {[1, 2, 3, 4, 5].map(i => <div key={i} className="flex-shrink-0 w-18 h-6 bg-surface-1 rounded opacity-70 hover:opacity-100 transition-opacity" />)}
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section id="value-grid" className="py-16 md:py-30">
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            image: screenshot7
          }].map((card, index) => <MotionCard key={index} initial={{
            opacity: 0,
            y: 20
          }} whileInView={{
            opacity: 1,
            ...
            boxShadow: "0 20px 50px rgba(0,0,0,0.55), 0 0 0 1px rgba(15,122,81,0.25)"
                ...
                <CardContent className="p-0">
                  ...
                  <div className="rounded-lg overflow-hidden">
                    <img src={card.image} alt={`${card.title} screenshot`} className="w-full h-48 object-cover object-center group-hover:scale-105 transition-transform duration-300" />
                  </div>
                </CardContent>
              </MotionCard>)}
          </div>
      ...
      <section id="testimonials" className="py-16 md:py-30 bg-surface-1">
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            rating: 4
          }].map((testimonial, index) => <MotionCard key={index} initial={{
            opacity: 0,
            y: 20
          }} whileInView={{
            opacity: 1,
            ...
            y: -2
                ...
                <CardContent className="p-0">
                  <div className="flex gap-1 mb-3">
                    {[...Array(5)].map((_, i) => <Star key={i} className={`w-4 h-4 ${i < testimonial.rating ? 'text-accent-primary fill-current' : 'text-text-low'}`} />)}
                  </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            ...
            delay: index * 0.2
                ...
                {index < 2 && <div className="hidden md:block absolute top-6 left-full w-full">
      ...
      <section className="py-16 md:py-30 bg-surface-1 relative overflow-hidden">
        ...
        <div className="container mx-auto relative">
          ...
          <div className="md:hidden flex gap-4 overflow-x-auto pb-4 snap-x snap-mandatory">
            {[{
            image: screenshot1,
            caption: "Dashboard & Quick Actions"
          }, {
            image: screenshot2,
            caption: "AI Prospect scenarios"
          }, {
            image: screenshot3,
            caption: "Practice session preview"
          }, {
            image: screenshot4,
            caption: "Performance breakdown"
          }, {
            image: screenshot5,
            caption: "Upload & Call Review"
          }, {
            image: screenshot6,
            caption: "Psychological Insights"
          }, {
            image: screenshot7,
            caption: "Replay Mode"
          }, {
            image: screenshot8,
            caption: "Progress & Challenges"
            ...
            delay: index * 0.1
                ...
                <div className="w-[280px] bg-surface-2 rounded-lg p-4 border border-border">
                  <img src={item.image} alt={item.caption} className="w-full h-[400px] object-cover rounded-lg mb-3" />
          ...
          <div className="hidden md:grid grid-cols-4 gap-6">
            ...
            scale: 1.03,
            y: -4
          }} className={`bg-surface-2 rounded-lg p-4 border border-border ${index % 2 === 1 ? 'transform translate-y-8' : ''}`}>
                <img src={item.image} alt={item.caption} className="w-full h-64 object-cover rounded-lg mb-3" />
                <p className="text-caption text-text-low text-center">{item.caption}</p>
              </motion.div>)}
          </div>
        </div>
      ...
      <section id="beta-signup" className="py-16 md:py-30">
        <div className="container mx-auto max-w-2xl">
          ...
          duration: 0.6
            ...
            {!isSubmitted ? <Card className="bg-surface-1 border border-border">
                <CardContent className="p-6">
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid md:grid-cols-2 gap-4">
                    ...
                    })} className="bg-surface-2 border-border focus:border-accent-primary" placeholder="Enter your email" />
                      </div>
                      <div className="space-y-2">
                      ...
                      ...formData,
                      name: e.target.value
                    })} className="bg-surface-2 border-border focus:border-accent-primary" placeholder="Enter your name" />
                      </div>
                    </div>
              ...
              </Card> : <Card className="bg-accent-primary/10 border border-accent-primary/25">
                <CardContent className="p-6">
        ...
        <div className="container mx-auto relative">
          ...
          duration: 0.6
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
              ...
              <Button variant="ghost" size="lg" onClick={() => window.open('https://instagram.com/prospector.app', '_blank')}>
                <Instagram className="w-4 h-4 mr-2" />
                Follow on Instagram
              </Button>
            </div>
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <button onClick={() => window.open('https://instagram.com/prospector.app', '_blank')} className="flex items-center gap-2 text-body-s text-text-medium hover:text-text-high transition-colors cursor-pointer">
      ...
      top: 0,
      behavior: 'smooth'
    })} className="fixed bottom-6 right-6 w-12 h-12 bg-accent-primary hover:bg-accent-hover text-white rounded-full flex items-center justify-center shadow-card hover:shadow-hover transition-all duration-200 z-40" aria-label="Back to top">
